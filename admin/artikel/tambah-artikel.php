...
<form action="artikel/tambah-artikel.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                <label>Titulu Artikel:</label>
                <input name="judul_artikel" type="text" class="form-control" placeholder="prenxe naran artikel" required>
            </div>
        </div>
    </div>
    <!-- rows -->   
                ...
                <input type="file" name="gambar" class="file" >
                    <div class="input-group my-3">
                        ...
                        <div class="input-group-append">
                            <button type="button" id="pilih_gambar" class="browse btn btn-dark">Hili Imajen</button>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <button type="submit" name="publish" class="btn btn-success">Publika</button>
                <button type="submit" name="simpan_konsep" class="btn btn-warning">Konsep</button>
            </div>
