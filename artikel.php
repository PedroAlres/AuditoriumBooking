...
<div class="row">
    <div class="col-sm-8">
        <div class="thumbnail">
            ...
            <div class="caption">
                <?php
                echo "<br>".strip_tags(html_entity_decode($data["isi_artikel"],ENT_QUOTES,"ISO-8859-1"));
                 ?>
                <hr>
            </div>
            <?php
            ...
            <!-- <div class="container">
                <iframe class="mb-4 mb-lg-0" src="https://maps.google.com/maps?q=UNTL&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" style="border:0; width: 100%; height: 384px;" allowfullscreen></iframe>
            </div> -->

            <div class="comment">
                <form method="post" action="simpan-komentar.php">
                    <label><h2>Rai hela komentariu</h2></label>
                    ...
                    <div class="form-group">
                        <input type="submit"  name="form_komentar" class="btn btn-info" value="Manda mensajen">
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="col-sm-4">
        ...
        <!-- <div class="row">
            <div class="col-sm-12">
                <img src="gambar/grupo.jpg" width="100%"alt="Cinque Terre">
            </div>
        </div> -->
    </div>  
</div>