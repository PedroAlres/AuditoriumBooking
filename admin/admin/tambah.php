...
?>
    <form action="admin/tambah.php" method="post">
        ...
        <div class="form-group">
            ...
            <input name="nama_pengguna" type="text" class="form-control" placeholder="Prenxe naran" required>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group">
                    <label>Email:</label>
                    <input name="email" type="email" class="form-control" placeholder="prenxe email" required>
            </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>No Telemovel:</label>
                    <input name="no_telp" type="text" class="form-control" placeholder="No telemovel" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input name="username" type="text" class="form-control" placeholder="prenxe username" required>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Password:</label>
                    <input name="password" type="password" class="form-control" placeholder="prenxe password" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <option value="1">Aktivu</option>
                    <option value="0">La Aktivu</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <button type="submit" name="simpan_tambah" class="btn btn-dark">Aumenta</button>
    </form>
