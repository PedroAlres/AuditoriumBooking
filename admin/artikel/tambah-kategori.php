<?php
    ...
    if (isset($_POST['tambah_kategori'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($simpan_kategori) {
                header("Location:../index.php?halaman=kategoria&tambah=berhasil");
            }
            else {
                header("Location:../index.php?halaman=kategoria&tambah=gagal");
            }
...
<form action="artikel/tambah-kategori.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-10">
            <div class="form-group">
                ...
                <input name="nama_kategori" type="text" class="form-control" placeholder="Prenxe naran kategoria" required>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <div id="msg"></div>
                <label>Imajen kategoria:</label>
                <input type="file" name="gambar_kategori" class="file" >
                    <div class="input-group my-3">
                        <input type="text" class="form-control" disabled placeholder="Upload Imajen" id="file">
                        <div class="input-group-append">
                                <button type="button" id="pilih_logo" class="browse btn btn-dark">Hili Imajen</button>
                        </div>
                    </div>
        ...
        <button type="submit" name="tambah_kategori" class="btn btn-dark">Aumenta</button>
</form>
<style>
    .file {
    visibility: hidden;
